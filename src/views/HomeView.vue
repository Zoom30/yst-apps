...
<template>
  <div class="home">
    <section class="hero">
      <div class="container">
        <h1 class="hero-title">Our Apps</h1>
        <p class="hero-sub">Simple, beautiful apps made for everyday use.</p>
      </div>
    </section>
      ...
      <div class="container">
        <div class="apps-grid">
          <div v-for="app in apps" :key="app.slug" class="app-card">
            <router-link :to="`/apps/${app.slug}`" class="card-body">
              <div class="card-icon">
                <img
                  v-if="app.icon.match(/\.(png|jpe?g|svg|webp)$/i)"
                  :src="baseUrl + app.icon"
                  :alt="app.name + ' logo'"
                  class="card-icon-img"
                />
            ...
            <div class="card-badges">
              ...
              <a v-else target="_blank" rel="noopener noreferrer" class="badge">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
